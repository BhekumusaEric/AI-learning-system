...
# Try different values of K and calculate inertia (within-cluster sum of squares)
...
for k in k_values:
    ...
    # Get inertia (lower is better)
    inertias.append(kmeans.inertia_)

# 1. Based on the elbow plot, what seems like a good value for K?
# Look at the inertias list - where does the improvement slow down?
best_k = 5  # Replace with your choice

# 2. Create final model with your chosen K
final_kmeans = KMeans(n_clusters=best_k, random_state=42)
final_kmeans.fit(customers)
